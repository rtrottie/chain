...
class NaDiffusionUnitSCANChain(SpinCustomChain):
    def __init__(self, vaspobj: Vasp(), standard=[], override=[], **kwargs):
        standard = [load_default_vasp, diffusion_standard_na, load_optimized_species_no_U, rough_converge, set_iopt_7, set_kpar_auto, scan, set_npar_2, set_kpar_2, cell_relax]
        gamma = [set_gamma, gamma_optimization, set_ncore_auto]
